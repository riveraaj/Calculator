...
public class Temperatura extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtOperacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 170, 30));
    ...
    public void conversorTemperatura() {
        ...
        if (box1.equals("Celsius") && box2.equals("Fahrenheit")) {
            double c = Double.parseDouble(txtOperacion.getText());
            double f = (double) (c * 1.8 + 32);
            txtOperacion2.setText(String.valueOf(String.format("%.2f", f)));
            String aux = "\nCelsius: " + txtOperacion.getText() + " a Fahrenheit: ";
            ...
            String aux = "\nCelsius: " + txtOperacion.getText() + " a Kelvin: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        } else if (box1.equals("Celsius") && box2.equals("Celsius")) {
            double c = Double.parseDouble(txtOperacion.getText());
            txtOperacion2.setText(String.valueOf(String.format("%.2f", c)));
            String aux = "\nCelsius: " + txtOperacion.getText() + " a Celsius: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        }
        ...
        if (box1.equals("Fahrenheit") && box2.equals("Celsius")) {
            double f = Double.parseDouble(txtOperacion.getText());
            double c = (double) ((f - 32) * 5 / 9);
            txtOperacion2.setText(String.valueOf(String.format("%.2f", c)));
            String aux = "\nFahrenheit: " + txtOperacion.getText() + " a Celsius: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
            ...
            txtOperacion2.setText(String.valueOf(String.format("%.2f", k)));
            String aux = "\nFahrenheit: " + txtOperacion.getText() + " a Kelvin: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
            ...
            double f = Double.parseDouble(txtOperacion.getText());
            txtOperacion2.setText(String.valueOf(String.format("%.2f", f)));
            String aux = "\nFahrenheit: " + txtOperacion.getText() + " a Fahrenheit: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        }
        ...
        if (box1.equals("Kelvin") && box2.equals("Celsius")) {
            ...
            txtOperacion2.setText(String.valueOf(String.format("%.2f", c)));
            String aux = "\nKelvin: " + txtOperacion.getText() + " a Celsius: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
            ...
            txtOperacion2.setText(String.valueOf(String.format("%.2f", f)));
            String aux = "\nKelvin: " + txtOperacion.getText() + " a Fahrenheit: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
            ...
            double k = Double.parseDouble(txtOperacion.getText());
            txtOperacion2.setText(String.valueOf(String.format("%.2f", k)));
            String aux = "\nKelvin: " + txtOperacion.getText() + " a Kelvin: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        }
    ...
    public void darkMode() {
        if (!modoOscuro) {
            ...
            jSeparator2.setForeground(Color.decode("#0db387"));
            jSeparator1.setBackground(Color.decode("#0db387"));
            jSeparator2.setBackground(Color.decode("#0db387"));
