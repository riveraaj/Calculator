 ...
 * @since 4/05/2022
 */
public class Presion extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Atmósfera", "Bar", "Kilopascal", "Pascal" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Atmósfera", "Bar", "Kilopascal", "Pascal" }));
    ...
    public void conversionPresion() {
        ...
        if (box1.equals("Atmósfera") && box2.equals("Bar")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double b = (double) (a * 1.0132);
            txtOperacion2.setText(String.valueOf(String.format("%.2f", b)));
            String aux = "\nAtmósfera: " + txtOperacion.getText() + " a Bar: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        } else if (box1.equals("Atmósfera") && box2.equals("Kilopascal")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double k = (double) (a * 101.32);
            txtOperacion2.setText(String.valueOf(String.format("%.2f", k)));
            String aux = "\nAtmósfera: " + txtOperacion.getText() + " a Kilopascal: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        } else if (box1.equals("Atmósfera") && box2.equals("Atmósfera")) {
            double a = Double.parseDouble(txtOperacion.getText());
            txtOperacion2.setText(String.valueOf(String.format("%.2f", a)));
            String aux = "\nAtmósfera: " + txtOperacion.getText() + " a Atmósfera: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        } else if (box1.equals("Atmósfera") && box2.equals("Pascal")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double p = (double) (a * 101325);
            txtOperacion2.setText(String.valueOf(String.format("%.2f", p)));
            String aux = "\nAtmósfera: " + txtOperacion.getText() + " a Pascal: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        }

        if (box1.equals("Bar") && box2.equals("Atmósfera")) {
            double b = Double.parseDouble(txtOperacion.getText());
            double a = (double) (b * 0.9869);
            txtOperacion2.setText(String.valueOf(String.format("%.2f", a)));
            String aux = "\nBar: " + txtOperacion.getText() + " a Atmósfera: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        } else if (box1.equals("Bar") && box2.equals("Kilopascal")) {
            double b = Double.parseDouble(txtOperacion.getText());
            double k = (double) (b * 100);
            txtOperacion2.setText(String.valueOf(String.format("%.2f", k)));
            String aux = "\nBar: " + txtOperacion.getText() + " a Kilopascal: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
            ...
            double b = Double.parseDouble(txtOperacion.getText());
            txtOperacion2.setText(String.valueOf(String.format("%.2f", b)));
            String aux = "\nBar: " + txtOperacion.getText() + " a Bar: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        } else if (box1.equals("Bar") && box2.equals("Pascal")) {
            double b = Double.parseDouble(txtOperacion.getText());
            double p = (double) (b * 100000);
            txtOperacion2.setText(String.valueOf(String.format("%.2f", p)));
            String aux = "\nBar: " + txtOperacion.getText() + " a Pascal: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        }

        if (box1.equals("Kilopascal") && box2.equals("Bar")) {
            double k = Double.parseDouble(txtOperacion.getText());
            double b = (double) (k * 0.01);
            txtOperacion2.setText(String.valueOf(String.format("%.2f", b)));
            String aux = "\nKilopascal: " + txtOperacion.getText() + " a Bar: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        } else if (box1.equals("Kilopascal") && box2.equals("Atmósfera")) {
            double k = Double.parseDouble(txtOperacion.getText());
            double a = (double) (k * 0.0099);
            txtOperacion2.setText(String.valueOf(String.format("%.2f", a)));
            String aux = "\nKilopascal: " + txtOperacion.getText() + " a Atmósfera: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        } else if (box1.equals("Kilopascal") && box2.equals("Kilopascal")) {
            double k = Double.parseDouble(txtOperacion.getText());
            txtOperacion2.setText(String.valueOf(String.format("%.2f", k)));
            String aux = "\nKilopascal: " + txtOperacion.getText() + " a Kilopascal: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        } else if (box1.equals("Kilopascal") && box2.equals("Pascal")) {
            double k = Double.parseDouble(txtOperacion.getText());
            double p = (double) (k * 1000);
            txtOperacion2.setText(String.valueOf(String.format("%.2f", p)));
            String aux = "\nKilopascal: " + txtOperacion.getText() + " a Pascal: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        }

        if (box1.equals("Pascal") && box2.equals("Bar")) {
            double p = Double.parseDouble(txtOperacion.getText());
            double b = (double) (p * 0.00001);
            txtOperacion2.setText(String.valueOf(String.format("%.5f", b)));
            String aux = "\nPascal: " + txtOperacion.getText() + " a Bar: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        } else if (box1.equals("Pascal") && box2.equals("Kilopascal")) {
            double p = Double.parseDouble(txtOperacion.getText());
            double k = (double) (p * 0.001);
            txtOperacion2.setText(String.valueOf(String.format("%.2f", k)));
            String aux = "\nPascal: " + txtOperacion.getText() + " a Kilopascal: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        } else if (box1.equals("Pascal") && box2.equals("Pascal")) {
            double p = Double.parseDouble(txtOperacion.getText());
            txtOperacion2.setText(String.valueOf(String.format("%.2f", p)));
            String aux = "\nPascal: " + txtOperacion.getText() + " a Pascal: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        } else if (box1.equals("Pascal") && box2.equals("Atmósfera")) {
            double p = Double.parseDouble(txtOperacion.getText());
            double a = (double) (p * 0.0000098692);
            txtOperacion2.setText(String.valueOf(String.format("%.6f", a)));
            String aux = "\nPascal: " + txtOperacion.getText() + " a Atmósfera: ";
            aux += txtOperacion2.getText();
            historial.insertarNodo(aux);
            aux = "";
        }
