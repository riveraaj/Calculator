 ...
 * @since 4/05/2022
 */
public final class Masa extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Gramos", "Libras", "Onzas", "Quilates", "Toneladas métricas" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Gramos", "Libras", "Onzas", "Quilates", "Toneladas métricas" }));
    ...
    public void conversionPresion() {
        String box2 = (String) jComboBox1.getSelectedItem();
        String box1 = (String) jComboBox2.getSelectedItem();

        if (box1.equals("Gramos") && box2.equals("Libras")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double b = (double) (a * 0.00220462);
            if (b < 0) {
                txtOperacion2.setText(String.format("%.2f", b));
                String aux = "\nGramos: " + txtOperacion.getText() + " a Libras: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
                txtOperacion2.setText(String.valueOf(String.format("%.2f", b)));
                String aux = "\nGramos: " + txtOperacion.getText() + " a Libras: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            }
        } else if (box1.equals("Gramos") && box2.equals("Onzas")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double k = (double) (a * 0.035274);
            if (k < 0) {
                txtOperacion2.setText(String.format("%.2f", k));
                String aux = "\nGramos: " + txtOperacion.getText() + " a Onzas: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
            ...
            double a = Double.parseDouble(txtOperacion.getText());
            if (a < 0) {
                txtOperacion2.setText(String.format("%.2f", a));
                String aux = "\nGramos: " + txtOperacion.getText() + " a Gramos: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
                txtOperacion2.setText(String.valueOf(String.format("%.2f", a)));
                String aux = "\nGramos: " + txtOperacion.getText() + " a Gramos: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            }
        } else if (box1.equals("Gramos") && box2.equals("Quilates")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double p = (double) (a * 5);
            if (p < 0) {
                txtOperacion2.setText(String.format("%.2f", p));
                String aux = "\nGramos: " + txtOperacion.getText() + " a Quilates: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Gramos") && box2.equals("Toneladas métricas")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double p = (double) (a * 0.000001);
            if (p < 0) {
                txtOperacion2.setText(String.format("%.2f", p));
                String aux = "\nGramos: " + txtOperacion.getText() + " a Toneladas métricas: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        if (box1.equals("Libras") && box2.equals("Gramos")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double b = (double) (a * 453.59);
            if (b < 0) {
                txtOperacion2.setText(String.format("%.2f", b));
                String aux = "\nLibras: " + txtOperacion.getText() + " a Gramos: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Libras") && box2.equals("Onzas")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double k = (double) (a * 16);
            if (k < 0) {
                txtOperacion2.setText(String.format("%.2f", k));
                String aux = "\nLibras: " + txtOperacion.getText() + " a Onzas: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
            ...
            if (a < 0) {
                txtOperacion2.setText(String.format("%.2f", a));
                String aux = "\nLibras: " + txtOperacion.getText() + " a Libras: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Libras") && box2.equals("Quilates")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double p = (double) (a * 2267.96);
            if (p < 0) {
                txtOperacion2.setText(String.format("%.2f", p));
                String aux = "\nLibras: " + txtOperacion.getText() + " a Quilates: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Libras") && box2.equals("Toneladas métricas")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double p = (double) (a * 0.00045359);
            if (p < 0) {
                txtOperacion2.setText(String.format("%.2f", p));
                String aux = "\nLibras: " + txtOperacion.getText() + " a Toneladas métricas: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        if (box1.equals("Onzas") && box2.equals("Libras")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double b = (double) (a * 0.0625);
            if (b < 0) {
                txtOperacion2.setText(String.format("%.2f", b));
                String aux = "\nOnzas: " + txtOperacion.getText() + " a Libras: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Onzas") && box2.equals("Gramos")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double k = (double) (a * 28.3495);
            if (k < 0) {
                txtOperacion2.setText(String.format("%.2f", k));
                String aux = "\nOnzas: " + txtOperacion.getText() + " a Gramos: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Onzas") && box2.equals("Onzas")) {
            double a = Double.parseDouble(txtOperacion.getText());
            if (a < 0) {
                txtOperacion2.setText(String.format("%.2f", a));
                String aux = "\nOnzas: " + txtOperacion.getText() + " a Onzas: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Onzas") && box2.equals("Quilates")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double p = (double) (a * 141.75);
            if (p < 0) {
                txtOperacion2.setText(String.format("%.2f", p));
                String aux = "\nOnzas: " + txtOperacion.getText() + " a Quilates: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Onzas") && box2.equals("Toneladas métricas")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double p = (double) (a * 0.0000283495);
            if (p < 0) {
                txtOperacion2.setText(String.format("%.2f", p));
                String aux = "\nOnzas: " + txtOperacion.getText() + " a Toneladas métricas: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        if (box1.equals("Quilates") && box2.equals("Libras")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double b = (double) (a * 0.00044092);
            if (b <= 0) {
                txtOperacion2.setText(String.format("%.2f", b));
                String aux = "\nQuilates: " + txtOperacion.getText() + " a Libras: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Quilates") && box2.equals("Onzas")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double k = (double) (a * 0.00705479);
            if (k < 0) {
                txtOperacion2.setText(String.format("%.2f", k));
                String aux = "\nQuilatess: " + txtOperacion.getText() + " a Onzas: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
                txtOperacion2.setText(String.valueOf(String.format("%.2f", k)));
                String aux = "\nQuilates: " + txtOperacion.getText() + " a Onzas: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            }
        } else if (box1.equals("Quilates") && box2.equals("Quilates")) {
            double a = Double.parseDouble(txtOperacion.getText());
            if (a < 0) {
                txtOperacion2.setText(String.format("%.2f", a));
                String aux = "\nQuilates: " + txtOperacion.getText() + " a Quilates: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Quilates") && box2.equals("Gramos")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double p = (double) (a * 0.2);
            if (p < 0) {
                txtOperacion2.setText(String.format("%.2f", p));
                String aux = "\nQuilates: " + txtOperacion.getText() + " a Gramos: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Quilates") && box2.equals("Toneladas métricas")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double p = (double) (a * (2.0 * (Math.pow(10, -7))));
            if (p < 0) {
                txtOperacion2.setText(String.format("%.2f", p));
                String aux = "\nQuilates: " + txtOperacion.getText() + " a Toneladas métricas: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        if (box1.equals("Toneladas métricas") && box2.equals("Libras")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double b = (double) (a * 2204.62);
            if (b < 0) {
                txtOperacion2.setText(String.format("%.2f", b));
                String aux = "\nToneladas métricas: " + txtOperacion.getText() + " a Libras: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Toneladas métricas") && box2.equals("Onzas")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double k = (double) (a * 35273.94);
            if (k < 0) {
                txtOperacion2.setText(String.format("%.2f", k));
                String aux = "\nToneladas métricas: " + txtOperacion.getText() + " a Onzas: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Toneladas métricas") && box2.equals("Toneladas métricas")) {
            double a = Double.parseDouble(txtOperacion.getText());
            if (a < 0) {
                txtOperacion2.setText(String.format("%.2f", a));
                String aux = "\nToneladas métricas: " + txtOperacion.getText() + " a Toneladas métricas: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Toneladas métricas") && box2.equals("Quilates")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double p = (double) (a * 5000000);
            if (p < 0) {
                txtOperacion2.setText(String.format("%.2f", p));
                String aux = "\nToneladas métricas: " + txtOperacion.getText() + " a Quilates: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
        ...
        } else if (box1.equals("Toneladas métricas") && box2.equals("Gramos")) {
            double a = Double.parseDouble(txtOperacion.getText());
            double p = (double) (a * 1000000);
            if (p < 0) {
                txtOperacion2.setText(String.format("%.2f", p));
                String aux = "\nToneladas métricas: " + txtOperacion.getText() + " a Gramos: ";
                aux += txtOperacion2.getText();
                historial.insertarNodo(aux);
                aux = "";
            } else {
