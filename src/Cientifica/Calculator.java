...
public class Calculator extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnAproxMen = new javax.swing.JButton();
        btnSeno = new javax.swing.JButton();
        btnCos = new javax.swing.JButton();
        btnTan = new javax.swing.JButton();
        btnExp = new javax.swing.JButton();
        btnRaiz = new javax.swing.JButton();
        btnAproxMay = new javax.swing.JButton();
        ...
        jPanel1.add(txtOperacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 310, 30));
        ...
        jPanel1.add(txtResultado, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 310, 50));
        ...
        jPanel2.add(btnAbsoluto, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 70, 40, 40));
        ...
        btnResiduo.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnResiduo.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1-touch.png"))); // NOI18N
        btnResiduo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnResiduoActionPerformed(evt);
            }
        });
        jPanel2.add(btnResiduo, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 40, 40));
        ...
        jPanel2.add(btnDivision, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 70, 40, 40));
        ...
        jPanel2.add(btnMultiplicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 130, 40, 40));
        ...
        jPanel2.add(btnResta, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 190, 40, 40));
        ...
        jPanel2.add(btnResultado, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 310, 40, 40));
        ...
        jPanel2.add(btnSuma, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 250, 40, 40));
        ...
        jPanel2.add(btn9, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 130, 40, 40));
        ...
        jPanel2.add(btn4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, 40, 40));
        ...
        jPanel2.add(btn6, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 190, 40, 40));
        ...
        jPanel2.add(btn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 250, 40, 40));
        ...
        jPanel2.add(btn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 250, 40, 40));
        ...
        jPanel2.add(btn3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 250, 40, 40));
        ...
        jPanel2.add(btn8, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 130, 40, 40));
        ...
        jPanel2.add(btnPunto, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 310, 40, 40));
        ...
        jPanel2.add(btn7, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 130, 40, 40));
        ...
        jPanel2.add(btn5, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 190, 40, 40));
        ...
        jPanel2.add(btnC, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 10, 40, 40));
        ...
        jPanel2.add(btnSigno, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 40, 40));
        ...
        jPanel2.add(btn0, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 310, 40, 40));
        ...
        jPanel2.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, 40, 40));

        btnAproxMen.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        btnAproxMen.setForeground(new java.awt.Color(55, 62, 71));
        btnAproxMen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnAproxMen.setText("≈˅");
        btnAproxMen.setBorder(null);
        btnAproxMen.setBorderPainted(false);
        btnAproxMen.setFocusPainted(false);
        btnAproxMen.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnAproxMen.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnAproxMen.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1-touch.png"))); // NOI18N
        btnAproxMen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAproxMenActionPerformed(evt);
            }
        });
        jPanel2.add(btnAproxMen, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 10, 40, 40));

        btnSeno.setFont(new java.awt.Font("Roboto Light", 1, 18)); // NOI18N
        btnSeno.setForeground(new java.awt.Color(55, 62, 71));
        btnSeno.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnSeno.setText("sin");
        btnSeno.setBorder(null);
        btnSeno.setBorderPainted(false);
        btnSeno.setFocusPainted(false);
        btnSeno.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnSeno.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnSeno.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1-touch.png"))); // NOI18N
        btnSeno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSenoActionPerformed(evt);
            }
        });
        jPanel2.add(btnSeno, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 40, 40));

        btnCos.setFont(new java.awt.Font("Roboto Light", 1, 18)); // NOI18N
        btnCos.setForeground(new java.awt.Color(55, 62, 71));
        btnCos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnCos.setText("cos");
        ...
        btnCos.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnCos.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1-touch.png"))); // NOI18N
        btnCos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCosActionPerformed(evt);
            }
        });
        jPanel2.add(btnCos, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 40, 40));

        btnTan.setFont(new java.awt.Font("Roboto Light", 1, 18)); // NOI18N
        btnTan.setForeground(new java.awt.Color(55, 62, 71));
        btnTan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnTan.setText("tan");
        ...
        btnTan.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnTan.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1-touch.png"))); // NOI18N
        btnTan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnTanActionPerformed(evt);
            }
        });
        jPanel2.add(btnTan, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 310, 40, 40));

        btnExp.setFont(new java.awt.Font("Roboto Light", 1, 18)); // NOI18N
        btnExp.setForeground(new java.awt.Color(55, 62, 71));
        btnExp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnExp.setText("exp");
        btnExp.setBorder(null);
        btnExp.setFocusPainted(false);
        btnExp.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnExp.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnExp.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1-touch.png"))); // NOI18N
        btnExp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnExpActionPerformed(evt);
            }
        });
        jPanel2.add(btnExp, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 70, 40, 40));
        ...
        jPanel2.add(btnRaiz, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 40, 40));

        btnAproxMay.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        btnAproxMay.setForeground(new java.awt.Color(55, 62, 71));
        btnAproxMay.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnAproxMay.setText("≈˄");
        btnAproxMay.setBorder(null);
        btnAproxMay.setFocusPainted(false);
        btnAproxMay.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnAproxMay.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnAproxMay.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1-touch.png"))); // NOI18N
        btnAproxMay.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAproxMayActionPerformed(evt);
            }
        });
        jPanel2.add(btnAproxMay, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 40, 40));

        btnLog.setFont(new java.awt.Font("Roboto Light", 1, 18)); // NOI18N
        btnLog.setForeground(new java.awt.Color(55, 62, 71));
        btnLog.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnLog.setText("log");
        btnLog.setBorder(null);
        btnLog.setFocusPainted(false);
        btnLog.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnLog.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1.png"))); // NOI18N
        btnLog.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/btn-1-touch.png"))); // NOI18N
        btnLog.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnLogActionPerformed(evt);
            }
        });
        jPanel2.add(btnLog, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 40, 40));
        ...
        jPanel2.add(btnElevadodos, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, 40, 40));
    ...
    private void btnAproxMenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAproxMenActionPerformed
        try {
            addOperacion("≈˅");
            oP.actionPerformed("≈˅", txtResultado);
            String aux = "\n" + txtOperacion.getText();
    ...
    private void btnCosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCosActionPerformed
        try {
            addOperacion(" COS");
            oP.actionPerformed("COS", txtResultado);
            String aux = "\n" + txtOperacion.getText();
            txtOperacion.setText("");
            txtOperacion.setText(txtResultado.getText());
            aux += "=" + txtResultado.getText();
    ...
    private void btnTanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTanActionPerformed
        try {
            addOperacion(" TAN");
            oP.actionPerformed("TAN", txtResultado);
            String aux = "\n" + txtOperacion.getText();
            txtOperacion.setText("");
            txtOperacion.setText(txtResultado.getText());
            aux += "=" + txtResultado.getText();
    ...
    private void btnExpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExpActionPerformed
        try {
            addOperacion("exp");
            oP.actionPerformed("Exp", txtResultado);
            String aux = "\n" + txtOperacion.getText();
            txtOperacion.setText("");
            txtOperacion.setText(txtResultado.getText());
            aux += "=" + txtResultado.getText();
    ...
    private void btnRaizActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRaizActionPerformed
        try {
            addOperacion("√");
            oP.actionPerformed("Sqrt", txtResultado);
            String aux = "\n" + txtOperacion.getText();
            txtOperacion.setText("");
            txtOperacion.setText(txtResultado.getText());
            aux += "=" + txtResultado.getText();
    ...
    private void btnAproxMayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAproxMayActionPerformed
        try {
            addOperacion("≈˄");
            oP.actionPerformed("≈˄", txtResultado);
            String aux = "\n" + txtOperacion.getText();
    ...
    }//GEN-LAST:event_btnAproxMayActionPerformed

    private void btnLogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogActionPerformed
        try {
            addOperacion("log");
            oP.actionPerformed("log", txtResultado);
            String aux = "\n" + txtOperacion.getText();
            txtOperacion.setText("");
            txtOperacion.setText(txtResultado.getText());
            aux += "=" + txtResultado.getText();
    ...
    private void btnElevadodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnElevadodosActionPerformed
        try {
            addOperacion("^(2)");
            oP.actionPerformed("x^2", txtResultado);
            String aux = "\n" + txtOperacion.getText();
            txtOperacion.setText("");
            txtOperacion.setText(txtResultado.getText());
            aux += "=" + txtResultado.getText();
...
//</editor-fold>
    ...
    public void btnResultado(java.awt.event.ActionEvent evt) {
        oP.actionPerformed("=", txtResultado);
        String aux = "\n" + txtOperacion.getText();
        txtOperacion.setText("");
        txtOperacion.setText(txtResultado.getText());
    ...
    public void darkMode() {
        if (!modoOscuro) {
            ...
            setButton1Dark(btnCos);
            setButton1Dark(btnSeno);
            setButton1Dark(btnTan);
            setButton1Dark(btnAproxMen);
            setButton1Dark(btnElevadodos);
            setButton1Dark(btnRaiz);
            setButton1Dark(btnLog);
            setButton1Dark(btnExp);
            setButton1Dark(btnAproxMay);
            setButton1Dark(btnC);
    ...
    private javax.swing.JButton btnAproxMay;
    private javax.swing.JButton btnAproxMen;
