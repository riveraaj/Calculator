 ...
 * @since 4/05/2022
 */
public final class MCD extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtOperacion2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 190, 140, 30));
        ...
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 310, 160, 10));
        ...
        jPanel1.add(txtResultado, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 160, 30));
    ...
    private void btnResultadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResultadoActionPerformed
        try {
            ...
            String aux = "\n" + txtOperacion.getText() + " MCD " + txtOperacion2.getText() + " :";
            boolean isNumeric;
            if ((isNumeric = aux1.matches("[+-]?\\d*(\\.\\d+)?") == true) && (isNumeric = aux2.matches("[+-]?\\d*(\\.\\d+)?") == true)) {
                ...
                txtResultado.setText(String.valueOf(df.format(maximoCD(a1, a2))));
    ...
    public double maximoCD(Double numero, Double numero2) {
        if (Objects.equals(numero, numero2)) {
            return numero;
        } else if (numero > numero2) {
            return maximoCD(numero - numero2, numero2);
        } else {
            return maximoCD(numero, numero2 - numero);
        }
    }
