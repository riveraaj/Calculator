...
public class Factorial extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtOperacion2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 160, 30));
        ...
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 160, 10));
    ...
    private void btnResultadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResultadoActionPerformed
        ...
        String resultado = String.valueOf(df.format(factorial(a)));
        txtOperacion2.setText(resultado);
